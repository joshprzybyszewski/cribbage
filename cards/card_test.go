...
func TestNewCardFromString(t *testing.T) {
	testCases := []struct {
		...
		desc:    `ace of hearts`,
		input:   `AH`,
		expCard: Card{Suit: Hearts, Value: 1},
	}, {
		desc:    `two of diamonds`,
		input:   `2D`,
		expCard: Card{Suit: Diamonds, Value: 2},
	}, {
		desc:    `10 of spades`,
		input:   `10S`,
		expCard: Card{Suit: Spades, Value: 10},
	}, {
		desc:    `Jack of Clubs`,
		input:   `JC`,
		expCard: Card{Suit: Clubs, Value: 11},
	}, {
		desc:    `Queen of Hearts`,
		input:   `QH`,
		expCard: Card{Suit: Hearts, Value: 12},
	}, {
		desc:    `King of Diamonds`,
		input:   `KD`,
		expCard: Card{Suit: Diamonds, Value: 13},
	}}
