...
export class FargateAppStack extends cdk.Stack {
    ...
    constructor(scope: cdk.Construct, id: string, props: FargateAppStackProps) {
        ...
        this.albFargateService = new ecs_patterns.ApplicationLoadBalancedFargateService(this, `${id}-fargate`, {
        ...
        const zone = HostedZone.fromHostedZoneId(this, `${id}-hz`, "hobbycribbage.com");
